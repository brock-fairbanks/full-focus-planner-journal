    ...
    >
      ...
      {!isFullscreen && (
        <>
          ...
          {/* Tools Sub Header */}
          <div className={`fixed top-16 right-0 h-10 bg-[#E5E0D8] flex items-center justify-end px-4 gap-4 z-40 ${activeTemplate === "JOURNAL" ? "left-40 md:left-44" : "left-20"} transition-all duration-300 ease-in-out`}>
            <button 
