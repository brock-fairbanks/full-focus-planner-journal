...
import { Send, Loader2, MessageSquare, Plus, MessagesSquare, Volume2, Square, VolumeX, Mic, Paperclip, X } from 'lucide-react';
...
export default function ChatSpread({ onClearCanvas }) {
    ...
    const [selectedModel, setSelectedModel] = useState(() => {
        return localStorage.getItem("planner_chat_model") || "gemini-3-flash-preview";
    });
