    ...
    >
      <textarea
        ...
        style={{
          ...
          fontSize: activeTemplate === 'IDEAL_WEEK' ? `${idealWeekFontSize}px` : `${Math.max(20, Math.min(42, Math.floor(lh * 0.98)))}px`,
          ...
          margin: 0,
          marginTop: activeTemplate === 'IDEAL_WEEK' ? 0 : '-3px', // Adjust vertical alignment to sit on lines better
